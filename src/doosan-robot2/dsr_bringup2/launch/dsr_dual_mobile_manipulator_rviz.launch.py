#
#  dsr_bringup2 - Dual Arm Mobile Manipulator Launch (M1013 Dual + Boxer/OTTO 100)
#  Author: Minsoo Song (minsoo.song@doosan.com)
#  Modified for dual arm mobile manipulator configuration
#
...
def generate_launch_description():
    ARGUMENTS = [
        ...
        DeclareLaunchArgument('model',      default_value='m1013_dual_mobile', description='ROBOT_MODEL'),
        ...
        DeclareLaunchArgument('torso_mount_height', default_value='0.15',   description='Torso mount height on base'),
    ]
    ...
    robot_description_content = Command(
        [
            ...
            " ",
            "torso_mount_height:=", LaunchConfiguration('torso_mount_height'),
        ]
    )
    ...
    # Mobile base controller (disabled - using fixed joints for visualization only)
    ...
    # Delay mobile base controller after dual controller (disabled)
    # delay_mobile_controller = RegisterEventHandler(
    #     event_handler=OnProcessExit(
    ...
    nodes = [
        ...
        # delay_mobile_controller,  # Disabled - no mobile base controller needed
    ]
