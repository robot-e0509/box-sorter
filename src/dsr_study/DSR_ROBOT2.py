...
_srv_name_prefix   = 'dsr_controller2/' # 서비스/토픽이 /<namespace>/dsr_controller2/... 에 등록됨
...
_ros2_set_singular_handling_force    = g_node.create_client(SetSingularHandlingForce, _srv_name_prefix +"motion/set_singularity_handling_force")
...
class CDsrRobot:
    def __init__(self, robot_id='dsr01', robot_model='m1013'):
        ...
        self._ros2_set_singular_handling_force    = g_node.create_client(SetSingularHandlingForce, self._srv_name_prefix +"/motion/set_singularity_handling_force") ; self.req_SetSingularHandlingForce = SetSingularHandlingForce.Request()
